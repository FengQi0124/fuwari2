...
export const fontConfig = {
	...
	preload: true,
	// 当前选择的字体，支持多个字体组合
	selected: ["oppo-sans", "lxgw-wenkai", "misans-regular", "misans-medium", "misans-semibold"] as string[],
...
// 本地字体
        "oppo-sans": {
            id: "oppo-sans",
            name: "OPPO Sans",
            src: "/assets/fonts/OPPOSans.woff2",
            family: "OPPOSans",
            weight: 400,
        ...
        "lxgw-wenkai": {
            id: "lxgw-wenkai",
            name: "LXGW WenKai",
            src: "/assets/fonts/LXGWWenKai-Regular.woff2",
            family: "LXGW WenKai",
            weight: 400,
            format: "woff2" as const,
            display: "swap" as const,
